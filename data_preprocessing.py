...
collision_reports = collision_reports.loc[:, ['date_time', 'address_road_primary', 'address_sfx_primary', 'address_name_intersecting', 'address_sfx_intersecting', 'injured', 'killed']]
